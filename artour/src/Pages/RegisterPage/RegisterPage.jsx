...
import {PRINCIPAL, AUXILIAR, TODO} from "../../components/Boton/styles"
  ...
  return (
    <>
      <div className='flex flex-overlay justify-center bg-[url(https://runrun.es/wp-content/uploads/2015/10/unimet1.jpg)] bg-cover m-0 ' >
        <div className='bg-white/90 flex flex-col gap-2 max-w-xl justify-center content-center m-16 w-3/4 p-12 z-10 rounded-3xl'>
          <h4 className="text-3xl text-left font-extrabold text-orange">Crea tu cuenta</h4>
          ...
          <div className=' w-full flex flex-col justify-around sm:grid-cols-2 sm:grid-rows-none gap-0 '>
            <form className='flex flex-col place-content-center gap-4 '>
              ...
              <div className='w-3/4 flex flex-col gap-3'>
                ...
                <Input label="Contraseña" type="text" name="password" id="password"/>
                <Input label="Confirme su contraseña" type="text" name="pass_confirm" id="pass_confirm"/>
              </div>
