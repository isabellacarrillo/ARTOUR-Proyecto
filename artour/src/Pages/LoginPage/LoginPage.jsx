...
import {PRINCIPAL, AUXILIAR, FACEBOOK, GOOGLE, TWITTER} from "../../components/Boton/styles"
  ...
  return (
    <>
      <div className='flex flex-overlay justify-center bg-[url(https://runrun.es/wp-content/uploads/2015/10/unimet1.jpg)] bg-cover m-0 ' >
        <div className='bg-white/90 flex flex-col gap-8 max-w-2xl justify-center content-center m-16 w-3/4 p-8 z-10 rounded-3xl '>
          <h4 className="text-3xl text-center font-extrabold text-orange">Ingresa a tu cuenta</h4>
